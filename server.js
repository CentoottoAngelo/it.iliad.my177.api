...
app.get('/', function (req, res) {
    ...
    res.send("<!doctype html><html><head><meta charset='utf-8' /><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0,minimum-scale=1.0, maximum-scale=1.0, user-scalable=no\"/><style>body {display: flex;padding: 0;margin: 0;width: 100vw;height: 100vh;align-items: center;justify-content: center;flex-direction: column;text-align: center;}main {font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";margin-top: 20px;}h1, h2 {font-weight: 500;font-size: 32px;}h2 {font-weight: 300;font-size: 16px;}</style></head><body><img src=\"https://i.imgur.com/Htnlhpj.png\" alt=\"My Iliad API\" title=\"My Iliad API\" height=\"192\" width=\"192\" /><main><h1>Access denied!</h1><h2>You do not have sufficient permissions to access.</h2></main></body></html>");
});
...
app.get('/alert', function (req, res) {
    ...
    data_store["iliad"][0] = "My Iliad è stata creata in modo <b>NON</b> ufficiale, pertanto non è collegata in nessun modo a Iliad S.p.a. Italia. L'applicazione salva le credenziali utente come ID e Password sul dispositivo in uso, tali dati sono usati <b>SOLO</b> per finalità per cui My Iliad offre il servizo."
    res.send(data_store);
});
